...
- Relationship to a hand-maintained per-project index (e.g. repo-A's `docs/plans/00-master-index.md`): `--board` is the generated equivalent; the two may coexist, and converging them is out of scope here.
